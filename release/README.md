...
| --- | --- | --- | --- | --- |
| 2026.08.04 | Phase 4：native authority race closure 与 POC 前最终 Linux gate | `975b89a` 关闭初始 3 Critical；后续 fresh review 的 1 Critical / 4 Warning 已进入 follow-up closure，完整 8/8 CI 与零缺陷 re-audit 待完成；未发布 release | [`2026.08.04.md`](./2026.08.04.md) | 待发布 |
